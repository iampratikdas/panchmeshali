...
function SettingIcons(props) {
  return (
    ...
    >
      <path
        d="M864.2,596c-9.2,38-23.3,72.2-43.7,105.4c-3.5,5.7-2.3,13.5,2.3,18.2c13,13,26.1,26,39,39
				...
				c1.8-7.6-2.4-16.6-10.5-18.5C874.9,583.8,866.2,587.9,864.2,596z"
      ></path>
      <path
        d="M674,512c0,4.7-0.2,9.3-0.5,14c-0.2,2.1-0.4,4.1-0.6,6.2c-0.1,0.8-0.5,3.8-0.1,0.8
				...
				c0-7.8-6.9-15.4-15-15C680.8,497.4,674,503.6,674,512z"
      ></path>
    </svg>
  );
}
...
function IconView(props) {
  return (
    ...
    >
      <g data-name="32. Veiw">
        <path d="M23.909 11.582C21.943 7.311 17.5 3 12 3S2.057 7.311.091 11.582a1.008 1.008 0 0 0 0 .836C2.057 16.689 6.5 21 12 21s9.943-4.311 11.909-8.582a1.008 1.008 0 0 0 0-.836ZM12 19c-4.411 0-8.146-3.552-9.89-7C3.854 8.552 7.589 5 12 5s8.146 3.552 9.89 7c-1.744 3.448-5.479 7-9.89 7Z"></path>
        <path d="M12 7a5 5 0 1 0 5 5 5.006 5.006 0 0 0-5-5Zm0 8a3 3 0 1 1 3-3 3 3 0 0 1-3 3Z"></path>
      </g>
    </svg>
  );
}
function IconLessThan(props) {
  return (
    <svg
      ...
      xmlSpace="preserve"
    >
      <path d="M64.916,84.833c-1.279,0-2.56-0.488-3.535-1.465L28.013,50l33.368-33.369c1.951-1.952,5.119-1.952,7.07,0  c1.953,1.953,1.953,5.119,0,7.071L42.155,50l26.296,26.298c1.953,1.952,1.953,5.118,0,7.07  C67.476,84.345,66.195,84.833,64.916,84.833z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <g>
        <g>
          <path
            d="M302.137,74.432h-21.031c-30.496-13.614-56.389-20.611-77.028-20.611c-26.731,0-39.245,11.649-44.906,20.535
